...
(function (Aufgabe07Neu) {
    ...
    function createArtikel() {
        for (let i = 0; i < Aufgabe07Neu.artikel.length; i++) {
            ...
            imgElement.src = Aufgabe07Neu.artikel[i].img;
            ...
            description.innerHTML = Aufgabe07Neu.artikel[i].description;
    ...
    function handleTrolley(_event) {
        ...
        localStorage.setItem("artikel_bild" + (cartArtikel.length - 1), Aufgabe07Neu.artikel[indexNr].img);
        localStorage.setItem("artikel_name" + (cartArtikel.length - 1), Aufgabe07Neu.artikel[indexNr].name);
        localStorage.setItem("artikel_description" + (cartArtikel.length - 1), Aufgabe07Neu.artikel[indexNr].description);
